...
public class Event {
	...
	public enum EventType {ExecutionComplete, MemoryRead, MemoryResponse, MemoryWrite, CacheRead_i, CacheResponse_i, CacheWrite_i, CacheRead_d, CacheResponse_d, CacheWrite_d};
